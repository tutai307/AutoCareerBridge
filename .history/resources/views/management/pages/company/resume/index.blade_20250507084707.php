        ...
        <div class="col-xl-12">
            <div class="filter cm-content-box box-primary">
                ...
                <div class="cm-content-body form excerpt" style="">
                    <form method="GET" action="{{ route('company.manageResumes') }}">
                        <div class="card-body">
                            <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <a href="{{ route('company.showResumes', $job->id) }}?tab=pending"
                                                        class="btn btn-info shadow btn-xs sharp me-1">
                                                        <i class="fa-solid fa-file-alt"></i>
                                                    </a>
                                                    <a href="{{ route('company.static', $job->id) }}"
                                                        class="btn btn-da shadow btn-xs sharp me-1">
