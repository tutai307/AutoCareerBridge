                            ...
                            <div class="jp_rightside_job_categories_wrapper jp_rightside_listing_single_wrapper">
                                ...
                                <div class="jp_job_post_right_overview_btn_wrapper">
                                    <div class="jp_job_post_right_overview_btn">
                                        @if (Auth::guard('admin')->check() && (Auth::guard('admin')->user()->role ===
                                        ROLE_COMPANY || Auth::guard('admin')->user()->role === ROLE_HIRING))
                                            @php
                                                $companyId = null;
                                                $isFollowed = false;
                                                $isPending = false;
                                            ...
                                            <div class="d-flex justify-content-end mt-2">
                                                ...
                                                @if (!$company)
                                                    ...
                                                    <a id="detailWorkshop" style="margin-left: 10px"
                                                       ...
                                                       data-slug="{{ $workshop->slug }}" data-id="{{ $workshop->id }}">
                                                        Xem chi tiết
                                                    </a>
                                                @else
                                                    ...
                                                    @elseif ($workshopStatus)
                                                        <a href="javascript:void(0)" class="btn btn-secondary px-4 ">Đã
                                                            gửi
                                                            yêu cầu tham gia</a>
        ...
        <div class="modal-dialog" style=" width: 60%; max-width: none;">
            ...
            <div class="modal-content">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="ul-li">
                                            <ul class="d-flex mb-2">
                                                <li class="me-3 me-lg-5 d-flex align-items-center">
                ...
                <div class="modal-footer">
                    ...
                    @endphp
                    @if ($companyId)
                        <button style="background-color: #337ab7; color: #e8e8e7" type="submit" class="btn px-4"
                                id="joinButton">
                            Tham gia
                        </button>
                    @endif
