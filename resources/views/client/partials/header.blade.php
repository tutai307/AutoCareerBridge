                ...
                <div class="col-lg-7 col-md-8 col-sm-12 col-xs-12 center_responsive">
                    <div class="header-area hidden-menu-bar stick" id="sticker">
                        ...
                        <div class="mainmenu">
                                ...
                                <ul>
                                    <li id="search_button">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             version="1.1" id="Capa_3"
                                             x="0px" y="0px" viewBox="0 0 451 451"
                                             style="enable-background:new 0 0 451 451;" xml:space="preserve"><g>
                                                <path id="search"
                            ...
                            <ul class="float_left text-white">
                                ...
                                <li class="parent gc_main_navigation"><a href="#" class="gc_main_navigation">candidates
