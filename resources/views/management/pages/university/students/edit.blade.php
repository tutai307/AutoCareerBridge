            ...
            <div class="row">
                    ...
                    <div class="clearfix">
                        <div class="card card-bx profile-card author-profile m-b30">
                            <div class="card-header">
                                <h6 class="card-title">Thông tin sinh viên</h6>
                            </div>
                                    ...
                                    <div class="avatar-upload text-center">
                                        <div class="position-relative">
                                            <div class="avatar-preview">
                                                <div id="imagePreview"
                                                    style="background-image: url({{ asset('storage/' . $student['avatar_path']) }}); width: 271px; height: 220px;">
                                                </div>
                                            </div>
                                            <div class="change-btn mt-2">
                                                <input type='file' class="form-control d-none" id="imageUpload"
                                                    name="avatar_path" accept=".png, .jpg, .jpeg">
                                                <label for="imageUpload" class="btn btn-primary light btn-sm">Chọn ảnh
                                                    mới</label>
                                            </div>
                                            @error('avatar_path')
                                                <span class="d-block text-danger mt-2">{{ $message }}</span>
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="card profile-card card-bx m-b30">
                                ...
                                <div class="col-sm-12 m-b30">
                                    ...
                                    <div class="mt-2">
                                        <label><input type="radio" name="gender" value="{{ MALE_GENDER }}"
                                                {{ old('gender', $student['gender']) == MALE_GENDER ? 'checked' : '' }}> Nam</label>
                                        <label class="ms-3"><input type="radio" name="gender" value="{{ FEMALE_GENDER }}"
                                                {{ old('gender', $student['gender']) == FEMALE_GENDER ? 'checked' : '' }}> Nữ</label>
                                    </div>
                                    @error('gender')
                                        <span class="d-block text-danger mt-2">{{ $message }}</span>
                                    @enderror
                        ...
                        <div class="card-footer">
                            <a href="{{ route('university.students.index') }}" class="btn btn-secondary">Quay lại</a>
