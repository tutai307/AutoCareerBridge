                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ $activeTab == 'accept' ? 'active' : '' }}" data-bs-toggle="tab"
                               href="#accept" id="tab-accept">
                                <i
                                    class="la la-check-circle mx-2"></i>{{ __('label.university.collaboration.accept') }}
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $activeTab == 'complete' ? 'active' : '' }}" data-bs-toggle="tab"
                               href="#complete" id="tab-complete">
                                <i
                                    class="la la-check-circle mx-2"></i>{{ __('label.university.collaboration.complete') }}
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ $activeTab == 'reject' ? 'active' : '' }}" data-bs-toggle="tab"
                               href="#reject" id="tab-reject">
                                <i
                                    class="la la-times-circle mx-2"></i>{{ __('label.university.collaboration.reject') }}
                            </a>
                        </li>
                    </ul>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"
                        id="detailsModalLabel">{{ __('label.university.collaboration.detail_colab') }}
                    </h5>
                                ...
                                <div class="card box-2 pt-0" style="max-height: 240px;">
                                    <div class="flow">
                                        <div class="dz-media"><img
                                            ...
                                            <p id="company-size">{{ __('label.university.collaboration.size') }}:
                                                ssss</p>
                                        </div>
                    ...
                    <form id="rejectForm" action="{{ route('university.changeStatusColab') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="feedbackContent"
                                      placeholder="{{ __('label.university.collaboration.feedback_placeholder') }}"
                                      name="res_message"
                                      rows="3"></textarea>
                        </div>
                    </form>
