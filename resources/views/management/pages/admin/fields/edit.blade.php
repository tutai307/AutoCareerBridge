                            ...
                            <div class="row">
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        placeholder="Công nghệ thông tin" name="name" id="name" oninput="ChangeToSlug()" value="{{ old('name', $fields->name) }}">
                                    @error('name')
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                        placeholder="cong-nghe-thong-tin" name="slug" id="slug" readonly value="{{ old('slug', $fields->slug) }}">
                                    @error('slug')
                                        <span class="d-block text-danger mt-2">{{ $message }}</span>
                                    @enderror
                                </div>
