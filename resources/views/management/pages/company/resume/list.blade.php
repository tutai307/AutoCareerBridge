                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link {{ request()->get('tab') == 'approved' ? 'active' : '' }}"
                                            ...
                                            <i class="la la-check-circle mx-2"></i>{{ __('label.company.applyJob.suitable') }}
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link {{ request()->get('tab') == 'rejected' ? 'active' : '' }}"
                                            href="{{ url()->current() }}?tab=rejected">
                                            <i class="la la-times-circle mx-2"></i>{{ __('label.company.applyJob.not_suitable') }}
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade {{ request()->get('tab') == 'pending' ? 'show active' : '' }}"
                                        ...
                                        <div id="pending-content">
                                            @include('management.pages.company.resume.table', [
                                                'data' => $pending,
                                            ])
                                        </div>
                                    </div>
