                        ...
                        <div class="card counter">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div class="chart-num">
                                    ...
                                    <p class="mb-0">Hồ sơ không phù hợp</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card counter">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div class="chart-num">
                                    ...
                                    <p class="mb-0">Hồ sơ chưa duyệt</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-header pb-0 border-0 flex-wrap">
                            <div class="mb-2 mb-sm-0">
                                <div class="chart-title mb-3">
                                    <h2 class="card-title">Thống kê hồ sơ ứng tuyển</h2>
                                </div>
                ...
                <div class="col-xl-3 wow fadeInUp" data-wow-delay="1s"
                    ...
                    <div class="card">
                        <div class="card-header border-0">
                            <h2 class="card-title">Tỉ lệ ứng viên trúng tuyển
                            </h2>
