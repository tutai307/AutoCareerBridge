                    ...
                    <div class="ul-li">
                        <ul class="d-flex mb-2">
                            <li class="me-3 me-lg-5">
                                <b>
                                    <b>
                                        ...
                                        </svg> {{ __('label.admin.job.create_by') }}:
                            ...
                            <li class="me-3 me-lg-5"><svg class="me-2" width="24" height="24"
                                ...
                                {{ __('label.admin.job.created_at') }}: {{ $data->created_at }}
                            </li>
                            ...
                            <li><svg class="me-2" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                {{ __('label.admin.job.end_date') }}: {{ $data->end_date }}</li>
                        </ul>
                    </div>
                    <div class="mt-4 job-detail">
                        <h3 class="card-title mb-3">{{ __('label.admin.job.detail_job') }}</h3>
                        {!! $data->detail ?? __('label.admin.job.empty') !!}
                    </div>
            </div>
        </div>
    </div>
        ...
        <div class="card box-2 pt-0" style="max-height: 245px;">
            <div class="flow">
                <div class="dz-media"><img
                    ...
                    <p>{{ __('label.admin.job.size') }}: {{ $data->company->size ?? '' }}</p>
                    @if (isset($data->company))
                        <p>{{ __('label.admin.job.place') }}:
        ...
        <div class="box-3">
            <div class="row">
                <div class="col-md-6 col-xl-12">
                    <div class="card task">
                        <h3 class="card-title mb-3">{{ __('label.admin.job.major') }}: {{ $data->major->name }}</h3>
                        <div class="fl-1 mb-4">
                            ...
                            <div class="fl-2">
                                <h4 class="card-title card-title--small">{{ __('label.admin.job.skills') }}:
