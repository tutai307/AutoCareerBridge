                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3  col-sm-6 mb-3 mb-xl-0">
                            ...
                            <select name="searchProvince" id="provinces"
                                    class="form-control default-select h-auto wide "
                                    aria-label="Default select example">
                                <option value="" selected>Địa Điểm</option>
                                @foreach($provinces as $province)
                                    <option
                                        value="{{$province->id}}" {{ request('searchProvince') == $province->id ? 'selected' : '' }}>{{$province->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-xl-3 col-sm-6 align-self-end">
                            <div>
                                <button class="btn btn-primary me-2" title="Click here to Search" type="submit"
                                        id="searchButton"><i class="fa-sharp fa-solid fa-filter me-2"></i>Tìm kiếm
                                </button>
                                <a href="/company/search-university">
                                    <button class="btn btn-danger light" title="Click here to remove filter"
                                            type="button" id="removeFilter">Xóa tìm kiếm
                                    </button>
                                </a>
                            </div>
                        </div>
