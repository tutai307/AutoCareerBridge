                                    ...
                                    <div class="avatar-upload text-center">
                                        <div class="position-relative">
                                            ...
                                            <div class="change-btn mt-2">
                                                ...
                                                <label for="imageUpload" class="btn btn-primary light btn-sm">{{ __('label.admin.management_university.workshop.select_avatar') }}</label>
                                            </div>
                                            @error('avatar_path')
                                                <span class="d-block text-danger mt-2">{{ $message }}</span>
                                            @enderror
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="card profile-card card-bx m-b30">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="row">
                                    <div class="col-sm-6 col-md-6 m-b30">
                                        <label
                                ...
                                <div class="col-sm-12 m-b30">
                                    <label for="amount" class="form-label">{{ __('label.admin.management_university.workshop.amount') }}
                                    </label>
                                ...
                                <div class="col-sm-12 m-b30">
                                    <label for="content" class="form-label">{{ __('label.admin.management_university.workshop.content') }}
                                    </label>
                                    <textarea name="content" id="content" class="form-control tinymce_editor_init @error('content') is-invalid @enderror" cols="30" rows="10"></textarea>
                                    @error('content')
                                        <span class="d-block text-danger mt-2">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="card-footer">
                            <a href="{{ route('university.workshop.index') }}" class="btn btn-secondary">{{ __('label.admin.back') }}</a>
