...
(function($) {
    ...
    sidebarPositionSelect.on('change', function() {
        this.value === "fixed" && body.attr('data-sidebar-style') === "modern" && body.attr('data-clients') === "vertical" ?
        alert("Sorry, Modern sidebar clients dosen't support fixed position!") :
    ...
    //change the theme clients controller
    layoutSelect.on('change', function() {
        if(body.attr('data-sidebar-style') === 'overlay') {
            body.attr('data-sidebar-style', 'full');
            body.attr('data-clients', this.value);
            return;
        }
    ...
    //change the container clients controller
    containerLayoutSelect.on('change', function() {
        if(this.value === "boxed") {

            if(body.attr('data-clients') === "vertical" && body.attr('data-sidebar-style') === "full") {
    ...
    sidebarStyleSelect.on('change', function() {
        if(body.attr('data-clients') === "horizontal") {
            if(this.value === "overlay") {
                alert("Sorry! Overlay is not possible in Horizontal clients.");
                return;
            }
        }

        if(body.attr('data-clients') === "vertical") {
            if(body.attr('data-container') === "boxed" && this.value === "full") {
                alert("Sorry! Full menu is not available in Vertical Boxed clients.");
                return;
            }

            if(this.value === "modern" && body.attr('data-sidebar-position') === "fixed") {
                alert("Sorry! Modern sidebar clients is not available in the fixed position. Please change the sidebar position into Static.");
                return;
            }
        }
